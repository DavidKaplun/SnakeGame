...
#fonts
FONT_SIZE=20
SEARCHING_FOR_PLAYERS_FONT_SIZE=60
...
BOARD1_NAME_OFFSET_X=3*SQUARE_SIZE
BOARD1_SCORE_OFFSET_X=6*SQUARE_SIZE
BOARD1_RANK_OFFSET_X=12*SQUARE_SIZE

BOARD2_NAME_OFFSET_X=17*SQUARE_SIZE
BOARD2_SCORE_OFFSET_X=20*SQUARE_SIZE
BOARD2_RANK_OFFSET_X=25*SQUARE_SIZE
...
SEARCHING_FOR_PLAYERS_OFFSET_X=13*SQUARE_SIZE
SEARCHING_FOR_PLAYERS_OFFSET_Y=6*SQUARE_SIZE

WINNING_SCORE=30

#constants of update the stats
SCORE_TO_ADD_AFTER_WIN=25
SCORE_TO_SUBTRACT_AFTER_LOSS=15

MINIMUM_RANK_TO_SUBTRACT_SCORE_FROM=15
