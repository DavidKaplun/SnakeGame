...
END_OF_GAME_BACK_BUTTON_Y_OFFSET=END_OF_GAME_BACKGROUND_Y_OFFSET+2*SQUARE_SIZE
...
PLAY_AGAIN_BUTTON_Y_OFFSET=END_OF_GAME_BACKGROUND_Y_OFFSET+4*SQUARE_SIZE
